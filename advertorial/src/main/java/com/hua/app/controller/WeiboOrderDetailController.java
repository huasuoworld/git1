...
@Controller
@RequestMapping(value = "/weiboOrderDetail")
public class WeiboOrderDetailController {

	@Resource
	private WeiboOrderDetailService service;
	
	@RequestMapping(value="/enter",method=RequestMethod.GET) 
	public String enter() {
		return "weiboOrderDetail";
	}
	
	@RequestMapping(value="/add",method=RequestMethod.GET) 
	public String add() {
		return "weiboOrderDetailADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(WeiboOrderDetailVO vo) {
		List<WeiboOrderDetailVO> list = service.search(vo);
