...
@Controller
@RequestMapping(value = "/weiboBatchPriceAdjustment")
public class WeiboBatchPriceAdjustmentController {

	@Resource
	private WeiboBatchPriceAdjustmentService service;
	
	@RequestMapping(value="/enter",method=RequestMethod.GET) 
	public String enter() {
		return "weiboBatchPriceAdjustment";
	}
	
	@RequestMapping(value="/add",method=RequestMethod.GET) 
	public String add() {
		return "weiboBatchPriceAdjustmentADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(WeiboBatchPriceAdjustmentVO vo) {
		List<WeiboBatchPriceAdjustmentVO> list = service.search(vo);
