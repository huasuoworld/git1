...
@Controller
@RequestMapping(value = "/famousPublic")
public class FamousPublicController {

	@Resource
	private FamousPublicService service;
	...
	public String add() {
		return "famousPublicADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(FamousPublicVO vo) {
		List<FamousPublicVO> list = service.search(vo);
