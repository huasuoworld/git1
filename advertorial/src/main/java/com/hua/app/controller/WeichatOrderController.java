...
@Controller
@RequestMapping(value = "/weichatOrder")
public class WeichatOrderController {

	@Resource
	private WeichatOrderService service;
	...
	public String add() {
		return "weichatOrderADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(WeichatOrderVO vo) {
		List<WeichatOrderVO> list = service.search(vo);
