...
@Controller
@RequestMapping(value = "/weiboAuthentication")
public class WeiboAuthenticationController {

	@Resource
	private WeiboAuthenticationService service;
	...
	public String add() {
		return "weiboAuthenticationADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(WeiboAuthenticationVO vo) {
		List<WeiboAuthenticationVO> list = service.search(vo);
