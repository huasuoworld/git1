...
@Controller
@RequestMapping(value = "/famousOrder")
public class FamousOrderController {

	@Resource
	private FamousOrderService service;
	...
	@ResponseBody
	public String search(FamousOrderVO vo) {
		List<FamousOrderVO> list = service.search(vo);
