...
@Controller
@RequestMapping(value = "/weichatOrderDetail")
public class WeichatOrderDetailController {

	@Resource
	private WeichatOrderDetailService service;
	
	@RequestMapping(value="/enter",method=RequestMethod.GET) 
	public String enter() {
		return "weichatOrderDetail";
	}
	
	@RequestMapping(value="/add",method=RequestMethod.GET) 
	public String add() {
		return "weichatOrderDetailADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(WeichatOrderDetailVO vo) {
		List<WeichatOrderDetailVO> list = service.search(vo);
