...
import com.hua.app.service.AreaManagerService;
...
public class AreaManagerController {
	...
	@Resource
	private AreaManagerService service;
	...
	public String add() {
		return "areaManagerADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(AreaManagerVO vo) {
		List<AreaManagerVO> list = service.search(vo);
