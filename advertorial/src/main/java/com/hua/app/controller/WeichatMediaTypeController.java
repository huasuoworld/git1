...
@Controller
@RequestMapping(value = "/weichatMediaType")
public class WeichatMediaTypeController {

	@Resource
	private WeichatMediaTypeService service;
	
	@RequestMapping(value="/enter",method=RequestMethod.GET) 
	public String enter() {
		return "weichatMediaType";
	}
	
	@RequestMapping(value="/add",method=RequestMethod.GET) 
	public String add() {
		return "weichatMediaTypeADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(WeichatMediaTypeVO vo) {
		List<WeichatMediaTypeVO> list = service.search(vo);
