...
@Controller
@RequestMapping(value = "/weiboWebsit")
public class WeiboWebsitController {

	@Resource
	private WeiboWebsitService service;
	...
	@ResponseBody
	public String search(WeiboWebsitVO vo) {
		List<WeiboWebsitVO> list = service.search(vo);
