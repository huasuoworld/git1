...
@Controller
@RequestMapping(value = "/includedReference")
public class IncludedReferenceController {

	@Resource
	private IncludedReferenceService service;
	...
	public String add() {
		return "includedReferenceADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(IncludedReferenceVO vo) {
		List<IncludedReferenceVO> list = service.search(vo);
