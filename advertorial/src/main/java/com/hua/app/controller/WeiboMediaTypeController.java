...
@Controller
@RequestMapping(value = "/weiboMediaType")
public class WeiboMediaTypeController {

	@Resource
	private WeiboMediaTypeService service;
	
	@RequestMapping(value="/enter",method=RequestMethod.GET) 
	public String enter() {
		return "weiboMediaType";
	}
	
	@RequestMapping(value="/add",method=RequestMethod.GET) 
	public String add() {
		return "weiboMediaTypeADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(WeiboMediaTypeVO vo) {
		List<WeiboMediaTypeVO> list = service.search(vo);
