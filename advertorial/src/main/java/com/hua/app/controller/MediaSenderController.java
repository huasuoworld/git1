...
@Controller
@RequestMapping(value = "/mediaSender")
public class MediaSenderController {

	@Resource
	private MediaSenderService service;
	...
	public String add() {
		return "mediaSenderADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(MediaSenderVO vo) {
		List<MediaSenderVO> list = service.search(vo);
