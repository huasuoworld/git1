...
@Controller
@RequestMapping(value = "/gunnerOrder")
public class GunnerOrderController {

	@Resource
	private GunnerOrderService service;
	...
	public String add() {
		return "gunnerOrderADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(GunnerOrderVO vo) {
		List<GunnerOrderVO> list = service.search(vo);
