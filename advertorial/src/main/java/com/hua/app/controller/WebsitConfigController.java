...
@Controller
@RequestMapping(value = "/websitConfig")
public class WebsitConfigController {

	@Resource
	private WebsitConfigService service;
	...
	public String add() {
		return "websitConfigADD";
	}
	
	//{message:"success",list:{did:"1"},count:20}
	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ResponseBody
	public String search(WebsitConfigVO vo) {
		List<WebsitConfigVO> list = service.search(vo);
